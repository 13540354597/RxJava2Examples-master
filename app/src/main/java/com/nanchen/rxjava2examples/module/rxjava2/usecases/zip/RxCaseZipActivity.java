...
public class RxCaseZipActivity extends RxOperatorBaseActivity {
    ...
    protected void doSomething() {
        ...
        Observable<CategoryResult> observable3 = Network.getGankApi()
                .getCategoryData("Android", 1, 1);


        Observable.zip(observable1, observable2, observable3, new Function3<MobileAddress, CategoryResult, CategoryResult, String>() {
            @Override
            public String apply(@NonNull MobileAddress mobileAddress, @NonNull CategoryResult categoryResult, @NonNull CategoryResult categoryResult2) throws Exception {
